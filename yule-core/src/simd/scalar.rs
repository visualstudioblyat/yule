...
pub fn vec_dot_dispatch(dtype: DType, block: &[u8], act: &[f32]) -> Option<f32> {
    match dtype {
        ...
        DType::Q4_1 => Some(dequant::vec_dot_q4_1(block, act)),
        DType::Q5_0 => Some(dequant::vec_dot_q5_0(block, act)),
        DType::Q5_1 => Some(dequant::vec_dot_q5_1(block, act)),
        DType::Q8_0 => Some(dequant::vec_dot_q8_0(block, act)),
        DType::Q8_1 => Some(dequant::vec_dot_q8_1(block, act)),
